...
def aec(n_trials, show, jobs, force):
    ...
    _run(RunSpec(frs.total_members, frs.failure_rate, 1650, 0), show=show, party_name="Flux+NoFilter", force=force)
    _run(RunSpec(round(frs.total_members * 1.2), (796 + frs.total_members * 0.1) / frs.total_members / 1.2, 1650, 0), show=show, party_name="Flux+Gain20%Lose10%", force=force)
    _run(RunSpec(round(frs.total_members * 1.2), (796 + frs.total_members * 0.1) / frs.total_members / 1.2, 1650, 24), show=show, party_name="Flux+Gain20%Lose10%", force=force)
    _run(RunSpec(round(frs.total_members * 2), (796 + frs.total_members * 0.333) / frs.total_members / 2, 1650, 0), show=show, party_name="Flux+Gain100%Lose33%", force=force)
    _run(RunSpec(round(frs.total_members * 2), (796 + frs.total_members * 0.333) / frs.total_members / 2, 1650, 24), show=show, party_name="Flux+Gain100%Lose33%", force=force)
    _run(RunSpec(frs.total_members, 0.5, 1650, 0), show=show, party_name="Flux+HalfBadMembers", force=force)
    _run(RunSpec(frs.total_members, 150/1650, frs.sample_size, frs.n_members_removed), show=show, party_name="Flux@Thresh", force=force)
    # _run(RunSpec(1650, 150/1650, 1650, 0), show=show, party_name="1650@Thresh", force=force)
    # _run(RunSpec(1650, 150/1650, 1650, 25), show=show, party_name="1650@Thresh+F25", force=force)
    # _run(RunSpec(1625, 150/1625, 1625, 0), show=show, party_name="1625@Thresh", force=force)
    # _run(RunSpec(1600, 150/1600, 1600, 25), show=show, force=force)
    # _run(RunSpec(1650, 0.06, 1650, 0), show=show, force=force)
    # _run(RunSpec(1650, 0.09, 1650, 0), show=show, force=force)
    # _run(RunSpec(1650, 0.16, 1650, 0), show=show, force=force)
    # _run(RunSpec(1650, 0.17, 1650, 0), show=show, force=force)
    # _run(RunSpec(1650, 150/1650, 1650, 0), show=show, force=force)
    # _run(RunSpec(1650, 150/1650, 1650, 5), show=show, force=force)
    # _run(RunSpec(1650, 150/1650, 1650, 18), show=show, force=force)
    # _run(RunSpec(1650, (150-18)/1650, 1650, 18), show=show, force=force)
    # _run(RunSpec(1650, 150/1650, 1650, 25), show=show, force=force)
    # _run(RunSpec(1750, 200/1750, 1650, 25), show=show, force=force)
    # _run(RunSpec(1850, 200/1850, 1650, 0), show=show, force=force)
    # _run(RunSpec(1850, 200/1850, 1650, 25), show=show, force=force)
    # _run(RunSpec(2000, 150/2000, 1650, 25), show=show, force=force)
    # _run(RunSpec(2000, 300/2000, 1650, 0), show=show, force=force)
    # _run(RunSpec(2000, 300/2000, 1650, 5), show=show, force=force)
    # _run(RunSpec(2000, 300/2000, 1650, 6), show=show, force=force)
    # _run(RunSpec(2000, 300/2000, 1650, 7), show=show, force=force)
    # _run(RunSpec(2000, 300/2000, 1650, 8), show=show, force=force)
    # _run(RunSpec(2000, 300/2000, 1650, 10), show=show, force=force)
    # _run(RunSpec(2000, 300/2000, 1650, 15), show=show, force=force)
    # _run(RunSpec(2000, 300/2000, 1650, 25), show=show, force=force)
    # _run(RunSpec(2000, 400/2000, 1650, 25), show=show, force=force)
    # _run(RunSpec(2500, 300/2500, 1650, 25), show=show, force=force)
    # _run(RunSpec(2500, 500/2500, 1650, 25), show=show, force=force)
    # _run(RunSpec(2500, 1000/2500, 1650, 25), show=show, force=force)
    _run(RunSpec(20000, 0.5, 1650, 0), show=show, force=force)
