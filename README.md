...
* Point 25 is dishonest -- Flux's arguments were ignored (update: seemingly confirmed by LEX3132 ([docs schedule](https://www.aec.gov.au/information-access/foi/2022/files/lex3132-schedule.pdf), [files](https://www.aec.gov.au/information-access/foi/2022/files/lex3132.zip))). Moreover, the exact thing that we criticized was the first thing that Ms Reid did.
...
* [The document cited to support point 29](https://www.aec.gov.au/Parties_and_Representatives/Party_Registration/Registration_Decisions/2021/notice-of-decision-with-reasons-SUPA.pdf) says:
  > &emsp; 8. [...] The Commission noted that this methodology was the same as the sampling methodology recommended by the Australian Bureau of Statistics ('ABS'). The Commission concluded that the methodology was appropriate for the purpose of membership testing, including because it was rational, fair and practical in all the circumstances."
